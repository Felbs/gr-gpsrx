...
def build_radio_qt():
    ...
    b = [
        ...
        blk("bias", "parameter", 960, 12, label="Bias-T (active antenna)", type="intx", value="0", short_id="b"),
        blk("fix_file", "parameter", 1200, 12, label="Fix file (keep it out of any repository)", type="str",
            value='""', short_id="o"),
