...
observable is dropped, and any observable more than 2.5 s older than the newest is ignored.""",
         make="gpsrx.pvt_solver(samp_rate=${samp_rate}, average=${average}, iono_file=${iono_file}, fix_file=${fix_file}, eph_file=${eph_file}, smoothing=${smoothing}, kf_vel_sd=${kf_vel_sd})",
